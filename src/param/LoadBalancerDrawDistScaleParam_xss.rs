...
pub struct LoadBalancerDrawDistScaleParam_xss {
    _data: LOAD_BALANCER_DRAW_DIST_SCALE_PARAM_ST,
}
impl Param for LoadBalancerDrawDistScaleParam_xss {
...
impl Deref for LoadBalancerDrawDistScaleParam_xss {
    type Target = LOAD_BALANCER_DRAW_DIST_SCALE_PARAM_ST;
    fn deref(&self) -> &Self::Target {
        self.data()
    }
}
impl DerefMut for LoadBalancerDrawDistScaleParam_xss {
