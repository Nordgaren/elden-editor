...
pub struct WwiseValueToStrParam_Switch_PlayerVoiceType {
    _data: WWISE_VALUE_TO_STR_CONVERT_PARAM_ST,
}
impl Param for WwiseValueToStrParam_Switch_PlayerVoiceType {
...
impl Deref for WwiseValueToStrParam_Switch_PlayerVoiceType {
    type Target = WWISE_VALUE_TO_STR_CONVERT_PARAM_ST;
    fn deref(&self) -> &Self::Target {
        self.data()
    }
}
impl DerefMut for WwiseValueToStrParam_Switch_PlayerVoiceType {
