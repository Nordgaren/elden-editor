...
pub struct LoadBalancerNewDrawDistScaleParam_ps5 {
	_data: LOAD_BALANCER_NEW_DRAW_DIST_SCALE_PARAM_ST
}
impl Param for LoadBalancerNewDrawDistScaleParam_ps5 {
...
impl Deref for LoadBalancerNewDrawDistScaleParam_ps5 {
	type Target = LOAD_BALANCER_NEW_DRAW_DIST_SCALE_PARAM_ST;
	fn deref(&self) -> &Self::Target {
		self.data()
	}
}
impl DerefMut for LoadBalancerNewDrawDistScaleParam_ps5 {
