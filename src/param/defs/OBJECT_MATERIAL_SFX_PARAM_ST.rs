...
pub struct OBJECT_MATERIAL_SFX_PARAM_ST {
    ...
    /// DESC: SFX identifier corresponding to the object parameter "SFX identifier after destruction" - オブジェパラメータの「破壊後着地SFX識別子」に対応する、SFX識別子
    pub sfxId_00: u32,
...
impl Paramdef for OBJECT_MATERIAL_SFX_PARAM_ST {
    const NAME: &'static str = "OBJECT_MATERIAL_SFX_PARAM_ST";
    const VERSION: u16 = 1;
}
