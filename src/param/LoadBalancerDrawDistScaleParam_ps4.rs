...
pub struct LoadBalancerDrawDistScaleParam_ps4 {
	_data: LOAD_BALANCER_DRAW_DIST_SCALE_PARAM_ST
}
impl Param for LoadBalancerDrawDistScaleParam_ps4 {
...
impl Deref for LoadBalancerDrawDistScaleParam_ps4 {
	type Target = LOAD_BALANCER_DRAW_DIST_SCALE_PARAM_ST;
	fn deref(&self) -> &Self::Target {
		self.data()
	}
}
impl DerefMut for LoadBalancerDrawDistScaleParam_ps4 {
